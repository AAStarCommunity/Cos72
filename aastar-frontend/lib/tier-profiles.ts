...
// Sepolia stablecoins (6 decimals). Canonical @aastar/sdk token-registry addresses — verified
// against the SDK bundle (single, consistent entry each) and the tokens/sale-client resolution.
// getTokenContracts() errors for Sepolia today, so these are pinned here; re-align with the SDK
// registry if it changes or exposes a Sepolia getter.
